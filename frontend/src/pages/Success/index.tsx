          ...
          <div className="col">
            <ul className="list-group">
              ...
              <div className="list-group-item list-group-item-action">
                ...
                <h5 className="mt-3 my-0"> Total: R$ {location.state.response.tickets.length * 30.0},00 </h5>
                <h5 className="mt-3 my-0 text-primary"> A ser transferido: R$ {location.state.response.tickets.length * 30.0},00 </h5>
                <h5 className="mt-4">PIX (Telefone): 98991201858 <br/><small>FRANSSINETE</small></h5>
              </div>
            </ul>
